...
- Designed functional UI mockups in Figma and translated design systems into pixel-perfect web interfaces.
- Assisted in integrating React.js components and Node.js logic while enforcing code quality using ESLint.

---

### 🚀 Key Projects

#### 🗂️ [Creatofly Daily — Team Task Manager](https://github.com/your-username/creatofly-daily)
...
- Planned and structured the site's **content hierarchy** and page-level information architecture for an easy customer journey.
- Configured **on-page SEO structure** (titles, headings, meta content) to improve discoverability.
- Managed layout, theming, and page configuration end-to-end using WordPress's design tools.
...
|---|---|---|
| Master of Computer Applications (MCA) | CSJM University, Kanpur (ODL) | Enrolled |
| B.Sc. Computer Science (CGPA: 8.49/10.0) | Indira College of Commerce and Science | 2022 – 2025 |
...
<p align="center">
  <img height="250" width"250" src="https://github.com/rohitpandeydatacore/My-task-Manager-project-/blob/main/dashboard.png" />
